...
gui.addColor(parameters, "htmlColor").onFinishChange((color) => {
	document.querySelector("html").style.backgroundColor = color
})

document.querySelector("html").style.backgroundColor = parameters.htmlColor
...
const tick = () => {
	deltaTime = clock.getDelta() // getElapstedTime() resets deltaTime to 0, so this must come first
