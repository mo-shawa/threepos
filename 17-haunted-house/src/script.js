...
const walls = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    ...
    aoMap: bricksAOTexture, // needs uv2 attribute to work, just copy uv coordinates
...
const door = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    ...
    transparent: true,
    aoMap: doorAmbientOcclusionTexture, // needs uv2 attribute to work
    displacementMap: doorHeightTexture, // moves vertices, so need to add more
...
renderer.setSize(sizes.width, sizes.height);
renderer.setPixelRatio(Math.min(window.devicePixelRatio, 2));
renderer.setClearColor("#262837"); // use same color as fog to blend horizon
